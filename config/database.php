    ...
    */
    ...
    'connections' => [
        ...
        'auth' => [
            ...
            'username' => env('AUTH_DB_USERNAME', 'laravel'),
        ...
        'characters' => [
            ...
            'host' => env('CHARACTER_DB_HOST', '127.0.0.1'),
            'port' => env('CHARACTER_DB_PORT', '3306'),
            'database' => env('CHARACTER_DB_DATABASE', 'characters'),
            'username' => env('CHARACTER_DB_USERNAME', 'laravel'),
            'password' => env('CHARACTER_DB_PASSWORD', ''),
            'unix_socket' => env('CHARACTER_DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
        ...
        'world' => [
            ...
            'username' => env('WORLD_DB_USERNAME', 'laravel'),
